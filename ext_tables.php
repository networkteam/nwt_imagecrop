...
//$GLOBALS['TCA']['tt_content']['palettes']['7']['showitem'] .= ', tx_nwtimagecrop_cropscaling';
//$GLOBALS['TCA']['tt_content']['palettes']['image_settings']['showitem'] .= ', --linebreak--, tx_nwtimagecrop_cropscaling';
...
//t3lib_extMgm::addToAllTCAtypes('tt_content','tx_nwtimagecrop_cropscaling','textpic,image','before:imageborder');
//t3lib_extMgm::addToAllTCAtypes('tt_content','tx_nwtimagecrop_cropscaling;;image_settings', 'textpic,image', 'before:imageborder');
